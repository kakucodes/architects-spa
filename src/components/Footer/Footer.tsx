...
export const Footer = () => {
  ...
  return (
    <FooterContainer sx={{ width: "100%" }}>
      <Container maxWidth="lg" sx={{ px: { xs: 3, sm: 4, md: 6, lg: 8 } }}>
          ...
          <Box sx={{ width: "100%" }}>
            <Grid2 container spacing={4} justifyContent="center">
              ...
              <Grid2 size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
                <Stack
                  spacing={2}
                  alignItems={getColumnCount() === 1 ? "center" : "flex-start"}
                >
                  <FooterLink href="https://www.architectsnft.io/">
                    Home
                  </FooterLink>
              ...
              <Grid2 size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
                ...
                >
                  ...
                  <InternalLink to="/mint">Mint</InternalLink>
                </Stack>
              </Grid2>
              ...
              {/* Column 4 */}
              <Grid2 size={{ xs: 12, sm: 6, md: 12, lg: 3 }}>
                <Stack
                  spacing={2}
                  alignItems={
                    getColumnCount() === 3 || getColumnCount() === 1
                      ? "center"
                      : "flex-start"
                  }
                >
